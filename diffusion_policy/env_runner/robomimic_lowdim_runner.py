...
class RobomimicLowdimRunner(BaseLowdimRunner):
    ...
    def __init__(self, 
            ...
            return MultiStepWrapper(
                    VideoRecordingWrapper(
                        RobomimicLowdimWrapper(
                            ...
                            output= output_dir if n_test==1 else None
                        ),
        ...
        for i in range(n_test):
            seed = test_start_seed + (i if n_test!=1 else int(output_dir.split('/')[-1]))
            enable_render = i < 50 #n_test_vis
