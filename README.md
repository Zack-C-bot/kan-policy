<div align="center">
      <td><h1>KAN Policy: Learning Efficient and Smooth Robotic Trajectories via Kolmogorov-Arnold Networks</h1></td>
</div>
...
```
For transformer-based models we apply [Kat Group](https://github.com/Adamdad/rational_kat_cu),  please follow the instuctions to install rational_kat:
```console
...
### Acknowledgement
We are pleased to announce that our paper titled 《__KAN Policy: Learning Efficient and Smooth Robotic Trajectories via Kolmogorov-Arnold Networks__》 has been accepted for publication in ___IEEE RA-L___. We extend our sincere gratitude to the reviewers and editors for their valuable feedback and recognition of our work.
